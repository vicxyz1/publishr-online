...
if (!class_exists('phpFlickr')) {
    ...
    class phpFlickr
    {
        ...
        function getRequestToken($callback, $permissions = 'read')
        {
            ...
            $data['oauth_signature'] = $this->getOauthSignature($this->oauthrequest_endpoint, $data);
...
//              redirect($this->oauthauthorize_en. '?oauth_token=' . $reponse['oauth_token'] . '&perms=' . $permissions);
            $this->error_code = '';
            $this->error_msg = '';
            return true;
        }
